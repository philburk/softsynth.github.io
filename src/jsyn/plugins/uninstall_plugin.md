...
Or if the box above is blank with a little red X in the corner then you need to install Java so please go [here.](/jsyn/support_old/plugin_win_sun/)

As far as we know, this uninstaller works. If the installer does not work then please copy the full text from the Applet above and [send it in an email to us here](/contacts/).