...
*   Add "Moog like" filters.
*   Expand the instrument set using a variety of synthesis architectures.
*   Add support for MIDI and HD(MIDI) style voice allocation and channel management. In other words, make it easier to "play notes" using JSyn.
*   Improve the documentation, examples and tutorial.