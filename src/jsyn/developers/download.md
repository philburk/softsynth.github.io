...
The source code is available on GitHub at [https://github.com/philburk/jsyn](https://github.com/philburk/jsyn) . You can build the code using ANT.
...
> [**jsyn-complete-20160812.jar**](/jsyn/developers/archives/jsyn-complete-20160812.jar) - released Aug 8, 2016 (deprecated)

The jar file below contains just the old JSyn API. You will need to combine it with the latest new JSyn JAR.

> [**jsyn-old-api-20161206.jar**](/jsyn/developers/archives/jsyn-old-api-20161206.jar) - released Dec 6, 2016 (deprecated)

### JPortAudio Binaries (optional)

JPortAudio is a wrapper for the PortAudio library. It can be used to provide multi-channel audio and 24-bit resolution to JSyn 16.5.3 and above. Documentation and source [here](https://app.assembla.com/spaces/portaudio/git/source/master/bindings/java/jportaudio.dox). Also please read the "index.html" in the downloaded archive.

1.  [jportaudio\_mac\_20120904.zip](/jsyn/developers/archives/jportaudio_mac_20120904.zip) - ALPHA - 9/4/12 for Intel Macintosh
2.  [jportaudio\_pc\_20120904.zip](/jsyn/developers/archives/jportaudio_pc_20120904.zip) - ALPHA - 9/4/12 for Windows
...
*   [jsyn\_16\_7\_3.jar](/jsyn/developers/archives/jsyn_16_7_3.jar) - released Dec 25, 2014
*   [jsyn\_16\_7\_1.jar](/jsyn/developers/archives/jsyn_16_7_1.jar) - released Nov 3, 2014
*   [jsyn\_16\_7\_0.jar](/jsyn/developers/archives/jsyn_16_7_0.jar) - released July 18, 2014
*   [jsyn-beta-16.6.4.jar](/jsyn/developers/archives/jsyn-beta-16.6.4.jar) - released February 2, 2014
*   [jsyn-beta-16.5.14.jar](/jsyn/developers/archives/jsyn-beta-16.5.14.jar) - released December 16, 2012