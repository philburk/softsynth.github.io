...
[How To Submit Events](#Submit)

## <a name="Upcoming"></a>Upcoming Events

## <a name="Ongoing"></a>Ongoing Events
...
A program that  "works like a 'normal' software sampler. It plays samples of a real cembalo. The difference is that it allows to use different tuning scales like pure major, werckmeister, pythagoras ...". For more information, contact [Nico Wald](mailto:nicowald@yahoo.com).
...
June 10, 2003, 8pm
Black Box, Oakland, CA ( [http://www.blackboxoakland.com/](http://www.blackboxoakland.com/) )
...
[Sonic Circuits DC](http://www.soniccircuits.com/about/)
August 2, 2002, 8pm
...
_"The performance is the software. The software interface is projected on a_
_screen for the audience. The sound is generated using JSyn. The dynamics of_
_the sound and visuals are tied to the progress of the performer through the_
_piece._

_The piece was inspired by a comment of a friend, after witnessing a full_
_evening of 'laptop rockers', and by the composer's love of constraint-based_
_literature. It unfolds like a book, and like a game: a mixture of_
_determinism and chance._

_To describe beyond this would reveal too much."_
...
_"At the southern end of the lake floats ... a cloud! A huge cloud of mist on the lakeshore which you can enter after crossing a landscape of gently rolling hills._
_The artificial mist is not an illusion: it consist of a metal construction that sprays innumerable tiny drops of lake water from 31,400 jets. This symbol of Yverdon's sensuous arteplage that functions in all weathers is a spectacular masterpiece of architecture and engineering."_

Sounds created using JSyn.

[Expo 2002 - http://ias.expo.02.ch/yverdon\_dem/cam.asp?Language=DE&Arteplage=4&Res=&HighRes=](http://ias.expo.02.ch/yverdon_dem/cam.asp?Language=DE&Arteplage=4&Res=&HighRes=)
[Cloud Architect - http://www.arcspace.com/architects/DillerScofidio/blur\_building/](http://www.arcspace.com/architects/DillerScofidio/blur_building/)

### Phil Burk demonstrating JSyn and JMSL at JavaOne Conference

Webcast from SUN site at: [http://java.sun.com/javaone/](http://java.sun.com/javaone/)
...
### [Monkey Farm](http://www.doctornerve.org/monkeyfarm/) by Nick Didkovsky

Friday May 4th
[Roulette](http://www.roulette.org), New York, NY
...
Listen to a short [mp3 excerpt](http://www.doctornerve.org/nerve/mp3/ramabroom.mp3) of a computer realization of the piece.
See a page of the [score](http://www.doctornerve.org/nerve/scores/ramabroom.jpg) (not same page as mp3 excerpt)
For more information, visit Nick's [event page](http://www.doctornerve.org/nerve/pages/gigs.shtml).
...
Sunday, August 27
Berlin, Germany
[International Computer Music Conference 2000](http://www.icmc2000.org/)
...
April 25-29, 2000
[DIEM](http://www.daimi.aau.dk/~diem/), Musikhuset
Aarhus, Denmark
[http://www.numus.dk/](http://www.numus.dk/)
...
James Forrest (computer), Joel Mellin (computer), Barbara Benary (Erh Hu / Chung Hu), [Nick Didkovsky](http://www.doctornerve.org) (composer/software)
...
## How To <a name="Submit"></a>Submit Events

You may submit news on JSyn related events on our [contacts page](/contacts/).
