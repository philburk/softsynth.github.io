...
This FAQ in [Français](/pforth/pf_faqfr.php)
...
* they required UNIX or other OS specific calls. (We had NO operating system)
* they required special preprocessors to build the dictionary which complicated our build process.
* they were a testbed for brilliant and sophisticated modifications to the Forth language which we admired but did not understand.
